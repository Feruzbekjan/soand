...
class AppFonts extends ThemeExtension<AppFonts> {
  final TextStyle fontSize32Weight800;
  ...
  final TextStyle fontSize20Weight800;
  ...
  final TextStyle fontSize13Weight400;
  ...
  AppFonts({
    ...
    required this.fontSize20Weight800,
    ...
    required this.fontSize13Weight400,
  ...
  ThemeExtension<AppFonts> lerp(
    ...
    return AppFonts(
      ...
      fontSize24Weight500: fontSize24Weight500,
